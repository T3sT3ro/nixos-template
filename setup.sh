...
echo -e "    --generate-hardware-config nixos-generate-config ./hardware-configuration.nix${NC}"
echo ""
...
echo ""
info "After installation completes, reboot. Then run post-install.sh for hibernation support."
